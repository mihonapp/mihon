...
) : Filter.Group<GenreFilter>(context.getString(R.string.genres), genres)
...
) : Filter.Group<AuthorFilter>(context.getString(R.string.authors), authors)
...
class ArtistGroup(
    context: Context,
    artists: List<ArtistFilter>,
) : Filter.Group<ArtistFilter>(context.getString(R.string.artists), artists)
...
) : Filter.Group<StatusFilter>(context.getString(R.string.status), filters)
