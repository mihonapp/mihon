...
- Fix custom chapter sort not being applied when adding to library by long press ([@perokhe](https://github.com/perokhe)) ([#1931](https://github.com/mihonapp/mihon/pull/1931))
