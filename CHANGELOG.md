...
- Fixed permission checkboxes not being checked during onboarding if using custom theme ([@Secozzi](https://github.com/Secozzi)) ([#3984](https://github.com/mihonapp/mihon/pull/3984))
