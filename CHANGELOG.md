...
- Fixed crash caused by incorrect handling of kitsu score type from login ([@Secozzi](https://github.com/Secozzi)) ([#3887](https://github.com/mihonapp/mihon/pull/3887))
