...
- Prevent duplicate requests due to empty reasonPhrase in WebView ([@AwkwardPeak7](https://github.com/AwkwardPeak7)) ([#1981](https://github.com/mihonapp/mihon/pull/2003))
