...
- Fix Add missing indexes for columns that are queried against but have no existing indexes ([@Lolle2000la](https://github.com/Lolle2000la)) ([#2950](https://github.com/mihonapp/mihon/pull/2950))
