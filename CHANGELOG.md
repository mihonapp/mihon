...
- Tweak Catppuccin color scheme for clarity ([@xenitane](https://github.com/xenitane)) ([#3410](https://github.com/mihonapp/mihon/pull/3410))
...
- Continue reading button missing when unread filter is off ([@AntsyLich](https://github.com/AntsyLich)) ([#3436](https://github.com/mihonapp/mihon/pull/3436))
