...
- Fix certain Xiaomi devices being unable to use any "Open link in browser" actions, including tracker setup ([@cuong-tran](https://github.com/cuong-tran)) ([#1776](https://github.com/mihonapp/mihon/pull/1776))
