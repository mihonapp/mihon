...
object EnglishStrings : DesktopStrings {
    ...
    override val cookieManagerDescription =
        "Manage source cookies and custom User-Agent headers for sign-in and site compatibility."
...
object SimplifiedChineseStrings : DesktopStrings {
    ...
    override val browseTabExtensions = "扩展"
    override val browseTabMigration = "图源迁移"
    override val browseManageRepositories = "扩展仓库"
    ...
    override val browseSearchPlaceholder = "搜索图源或扩展"
    ...
    override val extensionNsfwShort = "18+"
    override val extensionNsfwWarning = "本扩展包含成人（18+）内容。\n建议仅在知情且同意的情况下使用。"
    ...
    override val readerModeSingleLtr = "单页（从左到右）"
    override val readerModeSingleRtl = "单页（从右到左）"
    ...
    override val cookieManagerDescription = "管理图源的 Cookie 和自定义 User-Agent，用于登录状态及网站兼容设置。"
    ...
    override fun browseInstallExtensionTitle(name: String) = "安装扩展: $name"
    ...
    override val browseNetworkPermissionNotice = "安装扩展前请确认其网络声明权限。"
    override val browseTrustAndInstall = "信任并安装"
    override val browseAddRepository = "添加"
    override val browseConfiguredRepositories = "已配置的扩展仓库:"
    ...
    override fun onlineDetailScanlator(scanlator: String) = "翻译组/发布方: $scanlator"
...
object TraditionalChineseStrings : DesktopStrings {
    ...
    override val readerModeSingleLtr = "單頁（從左到右）"
    override val readerModeSingleRtl = "單頁（從右到左）"
    ...
    override val cookieManagerDescription = "管理圖源的 Cookie 和自訂 User-Agent，用於登入狀態及網站相容設定。"
    ...
    override fun onlineDetailScanlator(scanlator: String) = "翻譯組/發布方: $scanlator"
