...
@Composable
fun GorseSimilarRecommendationsCard(
            ...
            when {
                ...
                recommendations.isEmpty() -> {
                    ...
                    LazyRow(
                        ...
                        items(
                            items = recommendations.take(10), // 限制显示最多10个相似推荐
                            key = { it.itemId },
                        ) { recommendation ->
                            GorseSimilarRecommendationItem(
                                recommendation = recommendation,
                                onClick = {
                                    val sanitized = sanitizeForCopy(recommendation.itemId)
                                    context.copyToClipboard("相似推荐", sanitized)
...
@Composable
private fun GorseSimilarRecommendationItem(
        ...
        Card(
            ...
            Column(
                ...
                if (recommendation.score > 0) {
                    Text(
                        text = "相似度: ${String.format("%.1f%%", recommendation.score * 100)}",
