...
class AnilistRecommendationsTest {
    ...
    @Test
    fun `request targets an exact manga id without a title search`() {
    ...
    @Test
    fun `response preserves mapping metadata and server order`() {
              ...
              "recommendations": {
                "edges": [
                  ...
                  {"node":{"rating":10,"mediaRecommendation":{
                    "id":1004,"type":"MANGA","title":{"native":"\u7b2c\u56db\u90e8"}
                  }}},
