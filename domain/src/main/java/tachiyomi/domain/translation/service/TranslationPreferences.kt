...
class TranslationPreferences(
    ...
    val skipExistingOverlays: Preference<Boolean> = preferenceStore.getBoolean(
        "translation_skip_existing_overlays",
        true,
    )
    val autoShowOverlay: Preference<Boolean> = preferenceStore.getBoolean("translation_auto_show_overlay", true)
    val overlayTextSizeMode: Preference<String> = preferenceStore.getString(
        "translation_overlay_text_size_mode",
        "dynamic",
    )
    ...
    val overlayBoxFillColor: Preference<String> = preferenceStore.getString(
        "translation_overlay_box_fill_color",
        "#D2FFFFFF",
    )
    val overlayBoxStrokeColor: Preference<String> = preferenceStore.getString(
        "translation_overlay_box_stroke_color",
        "#E6202020",
    )
    val overlayBoxPaddingDp: Preference<Int> = preferenceStore.getInt("translation_overlay_box_padding_dp", 0)
    val overlayTextAlignment: Preference<String> = preferenceStore.getString(
        "translation_overlay_text_alignment",
        "center",
    )
